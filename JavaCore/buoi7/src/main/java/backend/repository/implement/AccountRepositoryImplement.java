package backend.repository.implement;
...
public class AccountRepositoryImplement implements IAccountRepository {
    ...
    public AccountRepositoryImplement() {
        departmentRepositoryImpl=new DepartmentRepositoryImplement();
        positionRepositoryImpl=new PositionRepositoryImplement();
    }
    @Override
